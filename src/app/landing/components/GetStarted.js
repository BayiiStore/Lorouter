        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install LoRouter, configure your providers via web dashboard, and start routing AI requests.
            </p>
            
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-[#1e6bff]/20 text-[#1e6bff] flex items-center justify-center font-bold">1</div>
                <div>
                  <h4 className="font-bold text-lg">Install LoRouter</h4>
                  <p className="text-sm text-gray-500 mt-1">Run npx command to start the server instantly</p>
                </div>
              </div>
              
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-[#1e6bff]/20 text-[#1e6bff] flex items-center justify-center font-bold">2</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-[#1e6bff]/20 text-[#1e6bff] flex items-center justify-center font-bold">3</div>
                <div>
          ...
          <div className="flex-1 w-full">
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#22314e] shadow-2xl">
              {/* Terminal header */}
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                ...
                <div className="text-gray-400 mb-6">
                  <span className="text-[#1e6bff]">&gt;</span> Starting LoRouter...<br/>
                  <span className="text-[#1e6bff]">&gt;</span> Server running on <span className="text-blue-400">http://localhost:20128</span><br/>
                  <span className="text-[#1e6bff]">&gt;</span> Dashboard: <span className="text-blue-400">http://localhost:20128/dashboard</span><br/>
