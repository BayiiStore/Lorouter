...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 z-50 w-full bg-[#060b16]/80 backdrop-blur-md border-b border-[#22314e]">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        >
          <img src="/logo.jpg" alt="LoRouter" className="size-8 rounded object-cover ring-1 ring-[#1e6bff]/40" />
          <h2 className="text-white text-xl font-bold tracking-tight">LoRouter</h2>
        </button>
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="hidden sm:flex h-9 items-center justify-center rounded-lg px-4 bg-[#1e6bff] hover:bg-[#1554d6] transition-all text-[#060b16] text-sm font-bold shadow-[0_0_15px_rgba(30,107,255,0.4)] hover:shadow-[0_0_20px_rgba(30,107,255,0.6)]"
          >
            Get Started
          </button>
          <button 
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-[#22314e] bg-[#060b16]/95 backdrop-blur-md">
          <div className="flex flex-col gap-4 p-6">
            ...
            <button 
              onClick={() => router.push("/dashboard")}
              className="h-9 rounded-lg bg-[#1e6bff] hover:bg-[#1554d6] text-[#060b16] text-sm font-bold"
            >
              Get Started
            </button>
          </div>
